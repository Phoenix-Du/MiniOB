...
RC LogicalPlanGenerator::create_plan(UpdateStmt *update_stmt, unique_ptr<LogicalOperator> &logical_operator)
{
  ...
  const char                 *attribute_name = update_stmt->attribute_name().c_str();
  ...
  unique_ptr<LogicalOperator> update_oper(new UpdateLogicalOperator(table, attribute_name, update_stmt->values(), update_stmt->value_amount()));
